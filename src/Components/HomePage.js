...
import AnimeListbyGenre from './Anime/AnimeListbyGenre';
import AnimeListbySearch from './Anime/AnimeListbySearch';
        ...
        >
            ...
            >
                <Grid item xs={8}>
                    ...
                    <Paper style={{ padding: 12, color: 'white', backgroundColor: '#222'}}>
                        <AnimeList />
                    </Paper>
                </Grid>
                <Grid item xs={4}>
